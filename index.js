...
if(DJSVersion === '^12.5.3') {
	...
	module.exports = {
		Sudo: require('./src/v14/Sudo'),
		Snake : require('./src/v14/Snake'),
		Fight : require('./src/v14/Fight'),
		Trivia : require('./src/v14/Trivia'),
		FastType : require('./src/v14/FastType'),
		QuickFind: require('./src/v14/QuickFind'),
		QuickClick : require('./src/v14/QuickClick'),
		ChaosWords : require('./src/v14/ChaosWords'),
		LieSwatter : require('./src/v14/LieSwatter'),
		Calculator : require('./src/v14/Calculator'),
		ShuffleGuess : require('./src/v14/ShuffleGuess'),
		GuessTheNumber : require('./src/v14/GuessTheNumber'),
		NeverHaveIEver : require('./src/v14/NeverHaveIEver'),
		WouldYouRather : require('./src/v14/WouldYouRather'),
		GuessThePokemon : require('./src/v14/GuessThePokemon'),
		RockPaperScissors : require('./src/v14/RockPaperScissors'),
		WillYouPressTheButton : require('./src/v14/WillYouPressTheButton'),
	};
}